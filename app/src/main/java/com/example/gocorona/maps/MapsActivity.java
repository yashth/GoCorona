...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(this);
        ...
        Log.d(TAG," intent currentLatitude: "+currentLatitude+" currentLongitude: "+ currentLongitude);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng currentUserLocation = new LatLng(currentLatitude, currentLongitude);
        Log.d(TAG,"onMapReady currentUserLocation: "+currentUserLocation);
        mMap.addMarker(new MarkerOptions().position(currentUserLocation).title("Marker in Current User Location"));
